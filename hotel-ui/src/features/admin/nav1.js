  ...
  return (
    <div>
      <Navbar bg="dark" data-bs-theme="dark">
        <Container>
          <Navbar.Brand href="/feelhome/admin/dashboard">FeelHome</Navbar.Brand>
          <Nav className="me-auto ">
            <Nav.Link onClick={() => navigate("/feelhome/admin/dashboard?page=bookings")}>Bookings</Nav.Link>
          </Nav>
          <Navbar.Collapse className="justify-content-end">
          
          <i className="pi pi-user" style={{ color: 'whitesmoke' }}  onClick={() => navigate("/feelhome/admin/profile")}></i>
